...
lstPths = [pacman_data_path + '{}/cbs/lh_era/bright_square/',
           pacman_data_path + '{}/cbs/lh_era/full_screen/',
           pacman_data_path + '{}/cbs/rh_era/bright_square/',
           pacman_data_path + '{}/cbs/rh_era/full_screen/']
