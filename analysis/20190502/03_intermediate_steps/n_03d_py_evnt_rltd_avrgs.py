...
lstIn_02 = ['EV_func_01_Rotated_Flicker.txt',
            'EV_func_02_Rotated_Flicker.txt',
            'EV_func_03_Rotated_Flicker.txt',
            'EV_func_04_Rotated_Flicker.txt',
            'EV_func_05_Rotated_Flicker.txt',
            'EV_func_06_Rotated_Flicker.txt']
...
# Output file name:
strOutFileName = 'ERA_Rotated_Flicker.nii.gz'
